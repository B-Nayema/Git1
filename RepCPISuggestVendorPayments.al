report 50000 "CPI Suggest Vendor Payments"
{
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    {
                        Caption = 'Payment Journal Line Generation';
                        ...
                        field(InsertInvoiceDesc; InsertInvoiceDesc)
                        {
                            ApplicationArea = All;
                            Caption = 'Insert Invoice Description';
    ...
    var
        ...
        DimMgtNVG: Codeunit DimensionManagement;
        DtldVendLedgEntry: Record "Detailed Vendor Ledg. Entry";
        //GLTranManagement: Codeunit GLTranManagementNVG;
        text50014: Label '%1 Payment to vendor %2 %3';
        Text50015: Label 'Payment of %1 %2';
        ACHInvoiceDescription: Option "Payment of External Doc No.","Vendor Name","Payment of Type and No.";
            ...
            repeat
                ...
                repeat
                    ...
                    if HandledEntry then begin
                        ...
                        //TBL
                        TempPaymentBuffer.Description := VendLedgEntry.Description;
                        //TBL
                        ...
                        if IsNotAppliedEntry(GenJnlLine, VendLedgEntry) then
                            if SummarizePerVend then begin
                                ...
                                //     TempPaymentBuffer."Ctl. Fund No. NVG" := VendLedgEntry."Ctl. Fund No. NVG";
                                // // DimMgt.DIMVendLedgEntryTOPaymentBuf(VendLedgEntry, TempPaymentBuffer);
                                // // DimMgt.DIMVendLedgEntryTOPaymentBuf(VendLedgEntry, TempPaymentBuffer);
                                // DimMgtNVG.DIMVendLedgEntryTOPaymentBuf(VendLedgEntry, TempPaymentBuffer);
    ...
    begin
        with GenJnlLine do begin
            ...
            if SummarizePerVend then begin
                ...
                Description := STRSUBSTNO(Text50014, 'ACH', TempPaymentBuffer."Vendor No.", TempPaymentBuffer."Applies-to Ext. Doc. No.");
            END ELSE BEGIN
            ...
            END;
            //TBL
            IF NOT (SummarizePerVend) AND (InsertInvoiceDesc) THEN
                Description := TempPaymentBuffer.Description;
            ...
            // DimMgtNVG.DIMPaymentBufferTOGenJnlLine(TempPaymentBuffer, GenJnlLine);
            // IF BankAcc.GET(GenJnlLine2."Bal. Account No.") THEN BEGIN
            //     BankAcc.TESTFIELD("AP Cash Control Fund NVG");
            //     "Ctl. Fund No. NVG" := BankAcc."AP Cash Control Fund NVG";
            // END ELSE
            //     IF "Ctl. Fund No. NVG" = '' THEN BEGIN
            //         "Ctl. Fund No. NVG" := GenJnlBatch."Ctl. Fund No. NVG";
            //     END;
            // //     IF FundManagement.CheckAPDistributed OR (NOT FundManagement.CheckAPEditable) THEN
            // //     VALIDATE("Fund No. NVG", "Ctl. Fund No. NVG")
            // //  ELSE BEGIN
            // VendLedgEntry.GET(TempPaymentBuffer."Vendor Ledg. Entry No.");
            // VALIDATE("Fund No. NVG", VendLedgEntry."Ctl. Fund No. NVG");
            // //   END;
            ...
            // //Navigator
            // IF (NOT FundManagement.CheckAPDistributed) OR (NOT FundManagement.CheckAPCashEditable) THEN BEGIN
            //     DimMgtNVG.DIMPaymentBufferTOGenJnlLine(TempPaymentBuffer, GenJnlLine);
            // END;
            // IF FundManagement.CheckAPDistributed AND (FundManagement.CheckAPCashEditable) THEN BEGIN
            //     DtldVendLedgEntry.SETCURRENTKEY("Vendor Ledger Entry No.", "Entry Type");
            //     DtldVendLedgEntry.SETRANGE("Vendor Ledger Entry No.", TempPaymentBuffer."Vendor Ledg. Entry No.");
            ...
            //         VALIDATE("Fund No. NVG", DtldVendLedgEntry."Fund No. NVG");
            //         VALIDATE("Shortcut Dimension 1 Code", DtldVendLedgEntry."Initial Entry Global Dim. 1");
            //         VALIDATE("Shortcut Dimension 2 Code", DtldVendLedgEntry."Initial Entry Global Dim. 2");
            //         VALIDATE("Shortcut Dimension 3 Code NVG", DtldVendLedgEntry."Initial Entry Global Dim 3 NVG");
            //         VALIDATE("Shortcut Dimension 4 Code NVG", DtldVendLedgEntry."Initial Entry Global Dim 4 NVG");
            //         VALIDATE("Shortcut Dimension 5 Code NVG", DtldVendLedgEntry."Initial Entry Global Dim 5 NVG");
            //         VALIDATE("Shortcut Dimension 6 Code NVG", DtldVendLedgEntry."Initial Entry Global Dim 6 NVG");
            //         VALIDATE("Shortcut Dimension 7 Code NVG", DtldVendLedgEntry."Initial Entry Global Dim 7 NVG");
            //         VALIDATE("Shortcut Dimension 8 Code NVG", DtldVendLedgEntry."Initial Entry Global Dim 8 NVG");
            //     END;
            // END;
            MODIFY(TRUE);
